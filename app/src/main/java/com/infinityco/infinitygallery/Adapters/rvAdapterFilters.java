...
public class rvAdapterFilters extends RecyclerView.Adapter<rvAdapterFilters.DataObjectHolder>{
    ...
    private static rvAdapterFilters.MyClickListener myClickListener;
    ...
    public void setOnItemClickListener(rvAdapterFilters.MyClickListener myClickListener) {
    ...
    @Override
    public rvAdapterFilters.DataObjectHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view;

        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.carditem_filter, parent, false);

        rvAdapterFilters.DataObjectHolder dataObjectHolder = new rvAdapterFilters.DataObjectHolder(view);
        return dataObjectHolder;
    }


    @Override
    public void onBindViewHolder(rvAdapterFilters.DataObjectHolder holder, final int position) {
