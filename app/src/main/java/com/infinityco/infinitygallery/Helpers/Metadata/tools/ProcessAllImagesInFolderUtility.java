...
package com.infinityco.infinitygallery.Helpers.Metadata.tools;


import com.infinityco.infinitygallery.Helpers.Metadata.imaging.FileType;
import com.infinityco.infinitygallery.Helpers.Metadata.imaging.FileTypeDetector;
import com.infinityco.infinitygallery.Helpers.Metadata.imaging.ImageMetadataReader;
import com.infinityco.infinitygallery.Helpers.Metadata.imaging.jpeg.JpegProcessingException;
...
import com.infinityco.infinitygallery.Helpers.Metadata.metadata.exif.ExifThumbnailDirectory;
import com.infinityco.infinitygallery.Helpers.Metadata.metadata.file.FileSystemDirectory;
...
public class ProcessAllImagesInFolderUtility
{
    ...
    private static void printUsage()
    {
        ...
        System.out.println();
        System.out.println("  java com.infinityco.infinitygallery.Helpers.Metadata.tools.ProcessAllImagesInFolderUtility [--text|--markdown|--unknown] [--log-file <file-name>]");
    }
    ...
    static class MarkdownTableOutputHandler extends FileHandlerBase
    {
        ...
        private void writeOutput(@NotNull PrintStream stream) throws IOException
        {
            ...
            for (Map.Entry<String, List<Row>> entry : _rowListByExtension.entrySet()) {
                ...
                for (Row row : rows) {
                    writer.write(String.format("[%s](https://raw.githubusercontent.com.infinityco.infinitygallery.Helpers.Metadatanoakes/metadata-extractor-images/master/%s/%s)|%s|%s|%d|%s|%s|%s|[metadata](https://raw.githubusercontent.com.infinityco.infinitygallery.Helpers.Metadatanoakes/metadata-extractor-images/master/%s/metadata/%s.txt)\n",
                            row.file.getName(),
                            row.relativePath,
