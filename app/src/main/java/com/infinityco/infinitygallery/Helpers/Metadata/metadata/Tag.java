 ...
 */
package com.infinityco.infinitygallery.Helpers.Metadata.metadata;
...
/**
 * Models a particular tag within a {@link com.infinityco.infinitygallery.Helpers.Metadata.metadata.Directory} and provides methods for obtaining its value.
 * Immutable.
 *
...
public class Tag
{
    ...
    /**
     * Get the name of the {@link com.infinityco.infinitygallery.Helpers.Metadata.metadata.Directory} in which the tag exists, such as
     * <code>Exif</code>, <code>GPS</code> or <code>Interoperability</code>.
     *
     * @return name of the {@link com.infinityco.infinitygallery.Helpers.Metadata.metadata.Directory} in which this tag exists
     */
    @NotNull
